            ...
            if self.numObjectives == 2:
                if gen % 50 == 0:
                    ...
                    for j in range(len(self.population)):
                        x.append(self.population[j].indiv.y_obj[0])
                        y.append(self.population[j].indiv.y_obj[1])
                ...
                if gen % 50 == 0:
                    ...
                    for j in range(len(self.population)):
                        x.append(self.population[j].indiv.y_obj[0])
                        y.append(self.population[j].indiv.y_obj[1])
                        z.append(self.population[j].indiv.y_obj[2])
                    plot_image(x, y, z)


        savefilename = "ParetoFront/DMOEA_" + self.strTestInstance + "_R" + str(rn) + ".dat"
